...
const CostaricaGet = async (req = request, res = response) => {
    ...
    res.json({
        msg:'Metodo GET Costa Rica - Jose Ernesto Escobar Martinez',
        total,
        costarica
    });
  }
  ...
  const CostaricaPost = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo POST Costa Rica - Jose Ernesto Escobar Martinez',
        costarica
    })
  }
  ...
  const CostaricaPut = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo PUT Costa Rica  - Jose Ernesto Escobar Martinez',
        codigo, 
        nombreproyecto, 
        paisqueejecuta, 
        fechacierre
  ...
  const CostaricaDelete = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo DELETE Costa Rica  - Jose Ernesto Escobar Martinez',
        costarica
    })
  }
